...
var iHeart = 'I heart';
let iHeartJavascript = iHeart + ' javascript';
...
// var stringToCheck = 'secret';

// for(var propertyName in briefing) {
...
let firstJedi = jedi.splice(0,1).toString();
...
let thirdJedi = jedi.slice(1,2).toString();
...
function tripleTheFun(parm) {
  if (isNaN(parm)){
    return parm+parm+parm;
  } else {
    return parm * 3;
  }
}
